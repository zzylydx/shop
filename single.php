   	 ...
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
					<li data-thumb="images/k4.jpg">
				         <div class="thumb-image"> <img src="images/k4.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
				    <li data-thumb="images/k5.jpg">
				         <div class="thumb-image"> <img src="images/k5.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
				    <li data-thumb="images/k6.jpg">
				       <div class="thumb-image"> <img src="images/k6.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li> 
				    <li data-thumb="images/k7.jpg">
				       <div class="thumb-image"> <img src="images/k7.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li> 
				  </ul>
			</div>
			</div>
			<div class="col-md-7 single-top-left simpleCart_shelfItem">
				...
				<h1>卡地亚女表</h1>
				<h4><b>卡地亚Cartier 蓝气球系列自动机械表玫瑰金女表W6920096<b></h4>
				<h6 class="item_price">¥156370.00</h6>			
				</p><h5>运费：00.00&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;国家：法国<h5></p>
				<h4>颜色分类</h4>
				<ul class="bann-btns">
					<li><select class="bann-size">
						<option value="select your location">颜色</option>
						<option value="saab">图示颜色W6920096</option>
					</select>
					</li>
