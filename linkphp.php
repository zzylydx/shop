   	 ...
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
				    <li data-thumb="<?php echo $urlimg;?>">
				        <div class="thumb-image"> <img src="<?php echo $urlimg;?>" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
				    <li data-thumb="<?php echo $urlimg;?>">
				         <div class="thumb-image"> <img src="<?php echo $urlimg;?>" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
			...
			<div class="col-md-7 single-top-left simpleCart_shelfItem">
				...
				<h4><b><?php echo $namex;?>,一件让你心动的商品<b></h4>
				<h6 class="item_price">¥<?php echo $price;?>.00</h6>			
